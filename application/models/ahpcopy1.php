  ...
  public function kriteriautama($id,$total)
    {
      ...
      $persentase1 = $eigenvector1*100;
      $pengeluaran1 = ($persentase1*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,29,1,$pengeluaran1);
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,1,4,$pengeluaran1);
      
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$total)/100;
      $this->subkriteriabb($id_keu,$pengeluaran2);
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,30,1,$pengeluaran2);

      $eigenvector3 = $totaldata3/$sumtotal;
      $persentase3 = $eigenvector3*100;
      $pengeluaran3 = ($persentase3*$total)/100;
      $this->subkriteriabpr($id_keu,$pengeluaran3);
      $this->inputdata->inputhasil($id_keu,$eigenvector3,$persentase3,31,1,$pengeluaran3);
      
      $eigenvector4 = $totaldata4/$sumtotal;
      $persentase4 = $eigenvector4*100;
      $pengeluaran4 = ($persentase4*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector4,$persentase4,32,1,$pengeluaran4);
    ...
    function subkriteriabpr($id,$pengeluaranbpr)
    {
      ...
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,26,3, $pengeluaran1);

      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$pengeluaranbpr)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,27,3,$pengeluaran2);
    ...
    public function subkriteriabb($id,$pengeluaranbb)
    {
      ...
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,33,2,$pengeluaran1);
      ...
      $pengeluaran2;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,34,2,$pengeluaran2);
      // eigenvector ketiga

      $eigenvector3 = $totaldata3/$sumtotal;
      $persentase3 = $eigenvector3*100;
      $pengeluaran3 = ($persentase3*$pengeluaranbb)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector3,$persentase3,35,2,$pengeluaran3);

      $eigenvector4 = $totaldata4/$sumtotal;
      $persentase4 = $eigenvector4*100;
      $pengeluaran4 = ($persentase4*$pengeluaranbb)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector4,$persentase4,36,2,$pengeluaran4);

      $eigenvector5 = $totaldata5/$sumtotal;
      $persentase5 = $eigenvector5*100;
      $pengeluaran5 = ($persentase5*$pengeluaranbb)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector5,$persentase5,37,2,$pengeluaran5);
      // eigenvector ketiga
      $eigenvector6 = $totaldata6/$sumtotal;
      $persentase6 = $eigenvector6*100;
      $pengeluaran6 = ($persentase6*$pengeluaranbb)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector6,$persentase6,38,2,$pengeluaran6);

      $eigenvector7 = $totaldata7/$sumtotal;
      $persentase7 = $eigenvector7*100;
      $pengeluaran7 = ($persentase7*$pengeluaranbb)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector7,$persentase7,39,2,$pengeluaran7);
      $this->inputdata->inputhasil($id_keu,$eigenvector7,$persentase7,25,2,$pengeluaran7);
      // Total eigenvector, total haruslah 1
      ...
      $vektorsum1[] = $eigenvector3*$data1[2];
      $vektorsum1[] = $eigenvector4*$data1[3];
      $vektorsum1[] = $eigenvector5*$data1[4];
      $vektorsum1[] = $eigenvector6*$data1[5];
      $vektorsum1[] = $eigenvector7*$data1[6];
      ...
      $vektorsum2[] = $eigenvector3*$data2[2];
      $vektorsum2[] = $eigenvector4*$data2[3];
      $vektorsum2[] = $eigenvector5*$data2[4];
      $vektorsum2[] = $eigenvector6*$data2[5];
      $vektorsum2[] = $eigenvector7*$data2[6];
      ...
      $vektorsum3[] = $eigenvector3*$data3[2];
      $vektorsum3[] = $eigenvector4*$data3[3];
      $vektorsum3[] = $eigenvector5*$data3[4];
      $vektorsum3[] = $eigenvector6*$data3[5];
      $vektorsum3[] = $eigenvector7*$data3[6];
      ...
      $vektorsum4[] = $eigenvector3*$data4[2];
      $vektorsum4[] = $eigenvector4*$data4[3];
      $vektorsum4[] = $eigenvector5*$data4[4];
      $vektorsum4[] = $eigenvector6*$data4[5];
      $vektorsum4[] = $eigenvector7*$data4[6];
      ...
      $vektorsum5[] = $eigenvector5*$data5[4];
      $vektorsum5[] = $eigenvector6*$data5[5];
      $vektorsum5[] = $eigenvector7*$data5[6];
      ...
      $vektorsum6[] = $eigenvector5*$data6[4];
      $vektorsum6[] = $eigenvector6*$data6[5];
      $vektorsum6[] = $eigenvector7*$data6[6];
      ...
      $vektorsum7[] = $eigenvector5*$data7[4];
      $vektorsum7[] = $eigenvector6*$data7[5];
      $vektorsum7[] = $eigenvector7*$data7[6];
    ...
    public function kriteriapp($id,$pengeluaranpp)
    {
      ...
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,23,2,$pengeluaran1);
      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$pengeluaranpp)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,24,2,$pengeluaran2);
      // Total eigenvector, total haruslah 1
      $totaleigenvector1 = $eigenvector1+$eigenvector2;      
      $data9 = array();
      $data9[] = ($data5[0]*$data5[0])+($data5[1]*$data6[0]);
    ...
    public function kriteriabhp($id,$pengeluaranpp)
    {
        $id = $id-1;
        $data_detail = $this->getdata->getDataBy($id);
          $value = array();
      ...
      $persentase1 = $eigenvector1*100;
      $pengeluaran1 = ($persentase1*$pengeluaranpp)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,6,2,$pengeluaran1);
      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$pengeluaranpp)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,7,2,$pengeluaran2);
      // Total eigenvector, total haruslah 1
      $totaleigenvector1 = $eigenvector1+$eigenvector2;      
      $data9 = array();
      $data9[] = ($data5[0]*$data5[0])+($data5[1]*$data6[0]);
    ...
    public function kriterialdj($id,$pengeluaranpp)
    {
        $id = $id-1;
        $data_detail = $this->getdata->getDataBy($id);
          $value = array();
      ...
      $persentase1 = $eigenvector1*100;
      $pengeluaran1 = ($persentase1*$pengeluaranpp)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,8,2,$pengeluaran1);
      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$pengeluaranpp)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,9,2,$pengeluaran2);
      // Total eigenvector, total haruslah 1
      $totaleigenvector1 = $eigenvector1+$eigenvector2;      
      $data9 = array();
      $data9[] = ($data5[0]*$data5[0])+($data5[1]*$data6[0]);
    ...
    public function kriteriaatk($id,$total)
    {
      ...
      $persentase1 = $eigenvector1*100;
      $pengeluaran1 = ($persentase1*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,2,2,$pengeluaran1);
      
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,3,2,$pengeluaran2);

      $eigenvector3 = $totaldata3/$sumtotal;
      $persentase3 = $eigenvector3*100;
      $pengeluaran3 = ($persentase3*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector3,$persentase3,4,2,$pengeluaran3);

      $eigenvector4 = $totaldata4/$sumtotal;
      $persentase4 = $eigenvector4*100;
      $pengeluaran4 = ($persentase4*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector4,$persentase4,5,2,$pengeluaran4);
    ...
    public function kriteriaks($id,$total)
    {
      ...
      $persentase1 = $eigenvector1*100;
      $pengeluaran1 = ($persentase1*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,18,2,$pengeluaran1);

      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,19,2,$pengeluaran2);
      
      // eigenvector ketiga
      $eigenvector3 = $totaldata3/$sumtotal;
      $persentase3 = $eigenvector3*100;
      $pengeluaran3 = ($persentase3*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector3,$persentase3,20,2,$pengeluaran3);

      $eigenvector4 = $totaldata4/$sumtotal;
      $persentase4 = $eigenvector4*100;
      $pengeluaran4 = ($persentase4*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector4,$persentase4,21,2,$pengeluaran4);

      $eigenvector5 = $totaldata5/$sumtotal;
      $persentase5 = $eigenvector5*100;
      $pengeluaran5 = ($persentase5*$total)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector5,$persentase5,22,2,$pengeluaran5);
    ...
    public function kriteriakbm($id,$pengeluarankbm)
    {
      ...
      $this->inputdata->inputhasil($id_keu,$eigenvector1,$persentase1,10,2,$pengeluaran1);

      // eigenvector kedua
      $eigenvector2 = $totaldata2/$sumtotal;
      $persentase2 = $eigenvector2*100;
      $pengeluaran2 = ($persentase2*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector2,$persentase2,11,2,$pengeluaran2);
      // eigenvector ketiga

      $eigenvector3 = $totaldata3/$sumtotal;
      $persentase3 = $eigenvector3*100;
      $pengeluaran3 = ($persentase3*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector3,$persentase3,12,2,$pengeluaran3);

      $eigenvector4 = $totaldata4/$sumtotal;
      $persentase4 = $eigenvector4*100;
      $pengeluaran4 = ($persentase4*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector4,$persentase4,13,2,$pengeluaran4);

      $eigenvector5 = $totaldata5/$sumtotal;
      $persentase5 = $eigenvector5*100;
      $pengeluaran5 = ($persentase5*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector5,$persentase5,14,2,$pengeluaran5);
      
      $eigenvector6 = $totaldata6/$sumtotal;
      $persentase6 = $eigenvector6*100;
      $pengeluaran6 = ($persentase6*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector6,$persentase6,15,2,$pengeluaran6);

      $eigenvector7 = $totaldata7/$sumtotal;
      $persentase7 = $eigenvector7*100;
      $pengeluaran7 = ($persentase7*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector7,$persentase7,16,2,$pengeluaran7);
      
      $eigenvector8 = $totaldata8/$sumtotal;
      $persentase8 = $eigenvector8*100;
      $pengeluaran8 = ($persentase8*$pengeluarankbm)/100;
      $this->inputdata->inputhasil($id_keu,$eigenvector8,$persentase8,17,2,$pengeluaran8);
      // Total eigenvector, total haruslah 1
      ...
      $hasil6 = $eigenvector15-$eigenvector7;
      $hasil6 = $eigenvector16-$eigenvector8;
      ...
      $vektorsum1[] = $eigenvector6*$data1[5];
      $vektorsum1[] = $eigenvector7*$data1[6];
      $vektorsum1[] = $eigenvector8*$data1[7];
      ...
      $vektorsum2[] = $eigenvector6*$data2[5];
      $vektorsum2[] = $eigenvector7*$data2[6];
      $vektorsum2[] = $eigenvector8*$data2[7];
      ...
      $vektorsum3[] = $eigenvector6*$data3[5];
      $vektorsum3[] = $eigenvector7*$data3[6];
      $vektorsum3[] = $eigenvector8*$data3[7];
      ...
      $vektorsum4[] = $eigenvector6*$data4[5];
      $vektorsum4[] = $eigenvector7*$data4[6];
      $vektorsum4[] = $eigenvector8*$data4[7];
      ...
      $vektorsum5[] = $eigenvector6*$data5[5];
      $vektorsum5[] = $eigenvector7*$data5[6];
      $vektorsum5[] = $eigenvector8*$data5[7];
      ...
      $vektorsum6[] = $eigenvector6*$data6[5];
      $vektorsum6[] = $eigenvector7*$data6[6];
      $vektorsum6[] = $eigenvector8*$data6[7];
      ...
      $vektorsum7[] = $eigenvector6*$data7[5];
      $vektorsum7[] = $eigenvector7*$data7[6];
      $vektorsum7[] = $eigenvector8*$data7[7];

      $vektorsum8 = array();
      $vektorsum8[] = $eigenvector1*$data8[0];
      $vektorsum8[] = $eigenvector2*$data8[1];
      $vektorsum8[] = $eigenvector3*$data8[2];
      $vektorsum8[] = $eigenvector4*$data8[3];
      $vektorsum8[] = $eigenvector5*$data8[4];
      $vektorsum8[] = $eigenvector6*$data8[5];
      $vektorsum8[] = $eigenvector7*$data8[6];
      $vektorsum8[] = $eigenvector8*$data8[7];
      ...
      $jumlahvektorsum7 = $vektorsum8[0]+$vektorsum8[1]+$vektorsum8[2]+$vektorsum8[3]+$vektorsum8[4]+$vektorsum8[5]+$vektorsum8[6]+$vektorsum8[7];
      ...
      $vk6 = $jumlahvektorsum6/$eigenvector6;
      $vk7 = $jumlahvektorsum7/$eigenvector7;
      $vk8 = $jumlahvektorsum8/$eigenvector8;
