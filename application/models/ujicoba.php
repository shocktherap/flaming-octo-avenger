...
* 
*/
class Ujicoba extends CI_Model
{
  ...
  // vk1 sama vk 4 subkriteriabb masih bermasalah
  // hasil perkalian persentase kriteria BB kurang 0,03 karena perbedaan desimal
  ...
  public function kriteriautama($id,$total)
    {
      ...
      print_r($data7);echo "</br>";
      print_r($data8);echo "</br>";
      ...
      echo "__________________________________________________</br>";
      print_r($totaldata1);echo "</br>";
      print_r($totaldata2);echo "</br>";
      print_r($totaldata3);echo "</br>";
      print_r($totaldata4);echo "</br>";
      print_r($sumtotal);echo "</br>";
      ...
      echo "__________________________________________________</br>";
      print_r($eigenvector1);echo "</br>";
      print_r($eigenvector2);echo "</br>";
      print_r($eigenvector3);echo "</br>";
      print_r($eigenvector4);echo "</br>";
      print_r($totaleigenvector1);echo "</br>";
      ...
      echo "__________________________________________________</br>";
      print_r($data9);echo "</br>";
      print_r($data10);echo "</br>";
      print_r($data11);echo "</br>";
      print_r($data12);echo "</br>";
      ...
      echo "__________________________________________________</br>";
      print_r($totaldata5);echo "</br>";
      print_r($totaldata6);echo "</br>";
      print_r($totaldata7);echo "</br>";
      print_r($totaldata8);echo "</br>";
      print_r($sumtotal2);echo "</br>";
      ...
      echo "__________________________________________________</br>";
      print_r($eigenvector5);echo "</br>";
      print_r($eigenvector6);echo "</br>";
      print_r($eigenvector7);echo "</br>";
      print_r($eigenvector8);echo "</br>";
      print_r($totaleigenvector2);echo "</br>";
      ...
      echo "jumlah</br>";
      print_r($jumlahvektorsum1);echo "</br>";
      print_r($jumlahvektorsum2);echo "</br>";
      print_r($jumlahvektorsum3);echo "</br>";
      print_r($jumlahvektorsum4);echo "</br>";
      echo "_____________________________ini_____________________";
      ...
      print_r($vk4);echo "</br>";
      // nilai lamda maks
      echo "lamda : ".$lamda              = ($vk1+$vk2+$vk3+$vk4)/$n;

      // menghitung indeks Konsistensi
      echo "IC ".$indekskonsistensi  = ($lamda - $n)/($n-1);

      $ir = $this->ujicoba->indeksrandom($n);

      // menghitung konsistensi rasio
      echo "RC: ".$rasiokonsistensi = $indekskonsistensi/$ir;
    ...
    function subkriteriabpr($id,$pengeluaranbpr)
    {
      ...
      echo "_______________________Matriks berpasangan___________________________</br>";
      print_r($data1);echo "</br>";
      print_r($data2);echo "</br>";
      echo "_______________________Perkalian Matriks___________________________</br>";
      print_r($data5);echo "</br>";
      print_r($data6);echo "</br>";
      echo "______________________Total Perbaris____________________________</br>";
      print_r($totaldata1);echo "</br>";
      print_r($totaldata2);echo "</br>";
      print_r($sumtotal);echo "</br>";
      echo "______________________Nilai Normalisasi____________________________</br>";
      print_r($eigenvector1);echo "</br>";
      print_r($eigenvector2);echo "</br>";
      print_r($totaleigenvector1);echo "</br>";
      echo "_____________________Perkalian matriks iterasi 2_____________________________</br>";
      print_r($data9);echo "</br>";
      print_r($data10);echo "</br>";
      echo "________________________Total Perbaris iterasi ke 2__________________________</br>";
      print_r($totaldata5);echo "</br>";
      print_r($totaldata6);echo "</br>";
      print_r($sumtotal2);echo "</br>";
      echo "_________________________Nilai normalisasi iterasi ke 2_________________________</br>";
      print_r($eigenvector5);echo "</br>";
      print_r($eigenvector6);echo "</br>";
      print_r($totaleigenvector2);echo "</br>";
      echo "_________________________Nilai perbedaan_________________________</br>";
      echo $hasil1."</br>";
      echo $hasil2."</br>";
      echo "_________________________Penjumlahan nilai eigen dan matriks awal_________________________</br>";
      print_r($jumlahvektorsum1);echo "</br>";
      print_r($jumlahvektorsum2);echo "</br>";
      echo "______________________Pembagian nilai prioritas dengan jumlah____________________________</br>";
      print_r($vk1);echo "</br>";
      print_r($vk2);echo "</br>";
      echo "____________________Lamda______________________________</br>";
      echo $lamda."</br>";
        echo "____________________________Indeks Konsistensi_____________________</br>";
      // menghitung indeks Konsistensi
      echo "konsistesi:".$indekskonsistensi."</br>";

      $ir = $this->ujicoba->indeksrandom($n);
      echo "______________________Konsistensi ratio____________________________</br>";
      // menghitung konsistensi rasio
      $rasiokonsistensi = $indekskonsistensi/$ir;
      $persenrasiokonsistensi = $rasiokonsistensi*100;
      if ($persenrasiokonsistensi > 10) {
        echo "waning :".$persenrasiokonsistensi;
      } else {
        echo "safe :".$persenrasiokonsistensi;
      }
    }
    ...
    public function subkriteriabb($id,$pengeluaranbb)
    {
      ...
      echo "eigenvector8 = ".$eigenvector8." dan eigenvector1 = ".$eigenvector1;
      ...
      print_r($data11);echo "</br>";
      print_r($data12);echo "</br>";
      print_r($data13);echo "</br>";
      print_r($data14);echo "</br>";
      echo "______________________Total Perbaris____________________________</br>";
      print_r($totaldata1);echo "</br>";
      print_r($totaldata2);echo "</br>";
      print_r($totaldata3);echo "</br>";
      ...
      print_r($totaleigenvector1);echo "</br>";
      echo "_____________________Perkalian matriks iterasi 2_____________________________</br>";
      print_r($data15);echo "</br>";
      print_r($data16);echo "</br>";
      print_r($data17);echo "</br>";
      print_r($data18);echo "</br>";
      print_r($data19);echo "</br>";
      print_r($data20);echo "</br>";
      print_r($data21);echo "</br>";
      echo "________________________Total Perbaris iterasi ke 2__________________________</br>";
      print_r($totaldata8);echo "</br>";
      print_r($totaldata9);echo "</br>";
      print_r($totaldata10);echo "</br>";
      print_r($totaldata11);echo "</br>";
      print_r($totaldata12);echo "</br>";
      print_r($totaldata13);echo "</br>";
      print_r($totaldata14);echo "</br>";
      print_r($sumtotal2);echo "</br>";
      echo "_________________________Nilai normalisasi iterasi ke 2_________________________</br>";
      print_r($eigenvector8);echo "</br>";
      print_r($eigenvector9);echo "</br>";
      print_r($eigenvector10);echo "</br>";
      print_r($eigenvector11);echo "</br>";
      print_r($eigenvector12);echo "</br>";
      print_r($eigenvector13);echo "</br>";
      print_r($eigenvector14);echo "</br>";
      print_r($totaleigenvector2);echo "</br>";
      echo "_________________________Nilai perbedaan_________________________</br>";
      echo $hasil1."</br>";
      echo $hasil2."</br>";
      ...
      print_r($jumlahvektorsum3);echo "</br>";
      print_r($jumlahvektorsum4);echo "</br>";
      print_r($jumlahvektorsum5);echo "</br>";
      print_r($jumlahvektorsum6);echo "</br>";
      print_r($jumlahvektorsum7);echo "</br>";
      echo "______________________Pembagian nilai prioritas dengan jumlah____________________________</br>";
      print_r($vk1);echo "</br>";
      print_r($vk2);echo "</br>";
      print_r($vk3);echo "</br>";
      ...
      print_r($vk6);echo "</br>";
      print_r($vk7);echo "</br>";
      echo "_______________________Lamda maks___________________________</br>";
      // nilai lamda maks
      echo $lamda = ($vk1+$vk2+$vk3+$vk4+$vk5+$vk6+$vk7)/$n."</br>";
echo "____________________________Indeks Konsistensi_____________________</br>";
      // menghitung indeks Konsistensi
      echo $indekskonsistensi = ($lamda - $n)/($n-1)."</br>";
    ...
    public function kriteriakbm($id,$pengeluarankbm)
    {
      ...
      print_r($data20);echo "</br>";
      print_r($data21);echo "</br>";
      print_r($data22);echo "</br>";
      print_r($data23);echo "</br>";
      print_r($data24);echo "</br>";
      echo "________________________Total Perbaris iterasi ke 2__________________________</br>";
      print_r($totaldata9);echo "</br>";
      print_r($totaldata10);echo "</br>";
      print_r($totaldata11);echo "</br>";
      ...
      print_r($totaldata13);echo "</br>";
      print_r($totaldata14);echo "</br>";
      print_r($totaldata15);echo "</br>";
      print_r($totaldata16);echo "</br>";
      print_r($sumtotal2);echo "</br>";
      echo "_________________________Nilai normalisasi iterasi ke 2_________________________</br>";
      print_r($eigenvector9);echo "</br>";
      print_r($eigenvector10);echo "</br>";
      ...
      print_r($eigenvector13);echo "</br>";
      print_r($eigenvector14);echo "</br>";
      print_r($eigenvector15);echo "</br>";
      print_r($eigenvector16);echo "</br>";
      print_r($totaleigenvector2);echo "</br>";
      echo "_________________________Nilai perbedaan_________________________</br>";
      echo $hasil1."</br>";
      echo $hasil2."</br>";
      ...
      print_r($jumlahvektorsum6);echo "</br>";
      print_r($jumlahvektorsum7);echo "</br>";
      print_r($jumlahvektorsum8);echo "</br>";
      echo "______________________Pembagian nilai prioritas dengan jumlah____________________________</br>";
      print_r($vk1);echo "</br>";
      print_r($vk2);echo "</br>";
      print_r($vk3);echo "</br>";
...
/* End of file ujicoba.php */
/* Location: ./application/models/ujicoba.php */
?>
